...
name: helm-runner
description: |
  Runs Stanford HELM's holistic scenario+metric matrix against Claude Code for multi-dimensional reporting (accuracy, calibration, robustness, fairness, bias, toxicity, efficiency). Publishes results in HELM-compatible JSON.
