...
name: augment-code
description: |
  Set up Augment Code's enterprise AI coding assistant optimized for large complex codebases with deep dependency understanding and architectural context.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, enterprise, coding-assistant]
---
# Augment Code
