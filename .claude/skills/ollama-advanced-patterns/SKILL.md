---
name: ollama-advanced-patterns
description: |
  Build production workflows with Ollama including Modelfile customization and multi-model serving.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [mlops, ollama, local]
---
# Ollama Advanced Patterns
