...
description: |
  Automation-first content platform with GTM AI workflows for sales, marketing, and operations teams. API integration triggers multi-step content pipelines for outbound emails, lead enrichment, and content repurposing.
