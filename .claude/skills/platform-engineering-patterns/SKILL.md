---
name: platform-engineering-patterns
description: |
  Design internal developer platforms with golden paths and platform-as-product principles.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [platform, engineering, patterns]
---
