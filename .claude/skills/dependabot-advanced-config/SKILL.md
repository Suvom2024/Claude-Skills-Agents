---
name: dependabot-advanced-config
description: |
  Set up advanced Dependabot with grouped updates, custom schedules, and security-only policies.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [devops, dependencies, dependabot]
---
