...
name: instructor-ai
description: |
  Extract structured, validated data from LLMs using Instructor's Pydantic-based library with automatic retries, streaming, and schema-first patterns.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, structured-output, instructor]
---
# Instructor Ai
