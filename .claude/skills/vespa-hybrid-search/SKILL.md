---
name: vespa-hybrid-search
description: |
  Vespa Yahoo's open-source engine unifying traditional search, vector search, and learned ranking with real-time indexing and on-the-fly embedding and multi-stage ranking at query time. Unique for learned ranking capabilities.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, search, vector]
---
# Vespa Hybrid Search
