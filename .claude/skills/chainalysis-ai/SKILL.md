...
name: chainalysis-ai
description: |
  Compliance-focused blockchain intelligence with AI risk scoring for KYT/AML. Wraps Chainalysis KYT, Reactor, and Address Screening APIs for transaction risk checks and investigation workflows.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, crypto, compliance]
---
# Chainalysis Ai
