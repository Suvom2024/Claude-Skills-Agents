---
name: adept-workflows
description: |
  Browser automation and computer-use patterns for adept-workflows to enable AI agents to interact with web/desktop interfaces in production.
