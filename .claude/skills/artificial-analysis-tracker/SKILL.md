---
name: artificial-analysis-tracker
description: |
  Pulls Artificial Analysis's independent quality-index, speed, and price leaderboard data to inform Claude Code model routing and sub-agent selection. Updates routing tables when new model versions ship.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, evals, routing]
---
# Artificial Analysis Tracker
