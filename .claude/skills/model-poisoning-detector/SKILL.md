---
name: model-poisoning-detector
description: |
  Detect backdoors and data poisoning in ML models using statistical analysis and activation clustering.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [security, ml, poisoning]
---
