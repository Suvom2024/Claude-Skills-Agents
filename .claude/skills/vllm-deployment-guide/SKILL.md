---
name: vllm-deployment-guide
description: |
  Deploy vLLM for high-throughput LLM serving with PagedAttention, continuous batching, and tensor parallelism.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [mlops, vllm, serving]
---
