...
name: nightfall-dlp
description: |
  Call Nightfall AI detection APIs to find and redact PII, PHI, PCI, and secrets in LLM traffic. Enforces DLP policies before text reaches third-party models.
