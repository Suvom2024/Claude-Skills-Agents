---
name: replicate-model-patterns
description: |
  Push, version, and serve models on Replicate with Cog packaging and prediction streaming.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [mlops, replicate, serving]
---
# Replicate Model Patterns
