---
name: apache-hudi-patterns
description: |
  Configure Hudi tables with CoW vs MoR trade-offs, incremental queries, and compaction tuning.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [data, hudi, lakehouse]
---
# Apache Hudi Patterns
