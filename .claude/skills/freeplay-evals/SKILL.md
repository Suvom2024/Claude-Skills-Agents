...
name: freeplay-evals
description: |
  Uses Freeplay's prompt-management + eval platform to version Claude Code prompts, run batched auto-evals, and collect human review in one workflow. Includes dataset curation from production logs.
