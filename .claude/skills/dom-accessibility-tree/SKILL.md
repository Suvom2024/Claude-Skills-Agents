---
name: dom-accessibility-tree
description: |
  Browser automation and computer-use patterns for dom-accessibility-tree to enable AI agents to interact with web/desktop interfaces in production.
