---
name: prometheus-judge
description: |
  Uses open-source Prometheus 2 (7B/8x7B) fine-tuned judge model as cost-efficient alternative for Claude Code rubric scoring. Supports direct-assessment and pairwise-ranking modes.
