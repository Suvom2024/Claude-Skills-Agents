---
name: vanna-ai-text-to-sql
description: |
  Vanna.ai RAG-powered text-to-SQL agent framework. Vanna 2.0 (late 2025) rearchitected as user-aware production agent with row-level security and audit logging. Main repo archived March 2026 but architecture patterns remain influential.
