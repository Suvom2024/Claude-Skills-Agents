---
name: calypso-ai-validate
description: |
  Use CalypsoAI Inference Platform to enforce scanners on prompts/responses across providers. Configures policies (PII, source code leak, jailbreak) and manages audit logs per user/model.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, safety, validation]
---
# Calypso Ai Validate
