---
name: meltano-singer-pipelines
description: |
  Meltano open-source DataOps platform built on Singer protocol, offering composable Python-based ELT with Git-versioned configuration. Well suited for engineering teams wanting full code control and CI/CD over ingestion pipelines.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [data, elt, opensource]
---
