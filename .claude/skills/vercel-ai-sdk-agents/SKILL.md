...
description: |
  Build streaming AI applications with the Vercel AI SDK's primitives for model routing, tool calling, structured output, and generative UI.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, vercel, streaming]
---
