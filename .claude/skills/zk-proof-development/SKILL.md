---
name: zk-proof-development
description: |
  Develop zero-knowledge circuits with Circom/Halo2/Noir, generate proofs, and integrate ZK into dApps.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [web3, zk-proofs, cryptography]
---
