---
name: duckdb-analytics-patterns
description: |
  Run analytical SQL with DuckDB over Parquet/CSV/JSON with extensions for spatial and HTTP queries.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [data, duckdb, analytics]
---
