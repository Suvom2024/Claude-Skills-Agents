---
name: dagger-pipeline-builder
description: |
  Define portable CI/CD pipelines as code in Go/Python/TypeScript using Dagger's container-native engine.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [devops, cicd, dagger]
---
# Dagger Pipeline Builder
