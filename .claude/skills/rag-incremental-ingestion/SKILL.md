---
name: rag-incremental-ingestion
description: |
  Advanced RAG pattern for rag-incremental-ingestion covering production retrieval-augmented generation.
