...
description: |
  Specialized speech enhancement API that removes background noise and improves vocal clarity. Integration processes recorded audio to studio-quality output, ideal for field recordings and remote interviews.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, audio, enhancement]
---
