---
name: rebuff-injection-detect
description: |
  Integrate Rebuff's multi-layered prompt injection detection (heuristics, vector DB, canary tokens). Provisions canary word insertion and feedback loops to continuously improve injection detection in agents.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, safety, injection]
---
# Rebuff Injection Detect
