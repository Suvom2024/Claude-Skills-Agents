---
name: view-transitions-api-patterns
description: |
  Build smooth page and state transitions using the View Transitions API for same-document and cross-document navigation.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [css, transitions, api]
---
