...
name: bloomberg-gpt
description: |
  Bloomberg's 50B-parameter financial LLM for terminal users handling news sentiment, earnings analysis, and NER on financial text. Surfaces BQL queries, sentiment scoring, and Bloomberg Terminal workflow automation.
