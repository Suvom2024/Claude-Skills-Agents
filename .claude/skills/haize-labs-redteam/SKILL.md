---
name: haize-labs-redteam
description: |
  Runs Haize Labs automated haizing attacks (jailbreaks, prompt injection, harmful output elicitation) against Claude Code agents before release. Produces attack traces and severity-scored reports.
