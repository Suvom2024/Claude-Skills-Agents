---
name: pyautogui-claude
description: |
  Browser automation and computer-use patterns for pyautogui-claude to enable AI agents to interact with web/desktop interfaces in production.
