...
name: kensho-ai
description: |
  S&P Global AI suite (NERD, Scribe, Link, Classify) for entity extraction and transcription on financial documents. Connects to Kensho APIs for document enrichment, speech-to-text on earnings calls, and entity linking.
