---
name: rag-over-structured-data
description: |
  Pattern for RAG over structured warehouse data combining text-to-SQL, semantic layer grounding, schema retrieval, and result summarization. Contrasts with document RAG and is backbone of modern conversational analytics products.
