---
name: deepnote-ai-agent
description: |
  Deepnote AI-first drop-in replacement for Jupyter with real-time collaboration, native data integrations across 50+ sources, and Deepnote agent for natural-language code generation and autonomous task execution.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, notebook, jupyter]
---
# Deepnote Ai Agent
