---
name: robust-intelligence-scanner
description: |
  Uses Robust Intelligence (now Cisco AI Defense) algorithmic red-teaming to probe Claude Code for OWASP LLM Top-10 vulnerabilities. Emits continuous validation findings for CI security gates.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, safety, redteam]
---
# Robust Intelligence Scanner
