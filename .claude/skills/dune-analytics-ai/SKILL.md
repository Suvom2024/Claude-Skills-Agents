---
name: dune-analytics-ai
description: |
  SQL-based blockchain analytics with AI query generation (Wand) for dashboards. Supports natural-language-to-SQL Dune queries, dashboard creation, and CSV exports of on-chain data.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, crypto, analytics]
---
# Dune Analytics Ai
