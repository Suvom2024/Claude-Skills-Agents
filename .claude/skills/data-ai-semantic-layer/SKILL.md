---
name: data-ai-semantic-layer
description: |
  Pattern for implementing governed semantic layer (dbt Semantic Layer, Cube, MetricFlow, AtScale) that powers both BI tools and AI agents with consistent metric definitions. Crucial for trustworthy text-to-SQL and conversational analytics in 2026.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, semantic-layer, analytics]
---
# Data Ai Semantic Layer
