---
name: mcp-server-testing-inspector
description: |
  Comprehensive patterns for building and configuring the mcp-server-testing-inspector MCP server for AI agent integration and Claude Code workflows.
