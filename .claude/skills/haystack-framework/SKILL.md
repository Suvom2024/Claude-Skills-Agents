...
description: |
  Build production RAG pipelines and AI agents with deepset's Haystack framework using modular components for retrieval, routing, and memory.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, rag, haystack]
---
# Haystack Framework
