...
name: alphasense-ai
description: |
  Market intelligence platform with generative AI search across earnings transcripts, broker research, and SEC filings. Query AlphaSense Smart Summaries, run thematic searches, and export citations for research reports.
