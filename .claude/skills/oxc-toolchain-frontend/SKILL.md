---
name: oxc-toolchain-frontend
description: |
  Use the OXC toolchain (parser, linter, resolver, transformer) as a high-performance Rust-based JS/TS tooling layer.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [tooling, oxc, rust]
---
# Oxc Toolchain Frontend
