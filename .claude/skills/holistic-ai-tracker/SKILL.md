---
name: holistic-ai-tracker
description: |
  Connect to Holistic AI Governance to track model risk, bias audits, and EU AI Act obligations. Pushes evaluation results and maintains inventory of production AI systems.
