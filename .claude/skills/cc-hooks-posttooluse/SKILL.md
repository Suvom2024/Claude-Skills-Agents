---
name: cc-hooks-posttooluse
description: |
  Configure PostToolUse hooks that run after successful tool completion for auto-formatting, linting, testing, and audit logging in Claude Code.
