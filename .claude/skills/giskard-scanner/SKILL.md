---
name: giskard-scanner
description: |
  Run Giskard's automated scan to detect hallucination, prompt injection, harmfulness, and robustness issues in LLMs and ML models. Generate test suites from scan findings and integrate with CI.
