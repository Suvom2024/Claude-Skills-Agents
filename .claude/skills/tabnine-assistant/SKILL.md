---
name: tabnine-assistant
description: |
  Integrate Tabnine's privacy-first AI code completion into IDE workflows with on-prem deployment options, codebase-aware suggestions, and enterprise SSO.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, code-completion, enterprise]
---
# Tabnine Assistant
