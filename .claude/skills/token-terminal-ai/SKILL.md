---
name: token-terminal-ai
description: |
  Financial metrics for crypto protocols (revenue, P/E, TVL) with AI-assisted analytics. Exposes Token Terminal API for fundamental data across DeFi protocols and L1/L2 chains.
