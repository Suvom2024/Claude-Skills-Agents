---
name: stylex-meta-patterns
description: |
  Style at scale using Meta's StyleX for atomic, build-time CSS with deterministic resolution and type safety.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [css, stylex, meta]
---
# Stylex Meta Patterns
