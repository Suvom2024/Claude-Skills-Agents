---
name: shoreline-incident-automation
description: |
  Author Shoreline Op Packs, Notebooks, and Action bundles for auto-remediation of Linux/Kubernetes incidents. Covers shoreline CLI scaffolding, safe dry-run execution, and wiring alerts from Datadog/PagerDuty into deterministic runbooks.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [aiops, devops, incident]
---
# Shoreline Incident Automation
