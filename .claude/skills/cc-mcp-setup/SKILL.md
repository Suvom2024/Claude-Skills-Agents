...
name: cc-mcp-setup
description: |
  Add MCP servers at user/local/project scope, configure .mcp.json for team sharing, troubleshoot connections with stdio and streamable-http transports.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [claude-code, mcp, configuration]
---
# Cc Mcp Setup
