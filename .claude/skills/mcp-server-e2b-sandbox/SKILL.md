---
name: mcp-server-e2b-sandbox
description: |
  Comprehensive patterns for building and configuring the mcp-server-e2b-sandbox MCP server for AI agent integration and Claude Code workflows.
