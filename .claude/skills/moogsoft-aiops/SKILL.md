...
name: moogsoft-aiops
description: |
  Guides Moogsoft (Dell APEX AIOps) Situation Rooms, Correlation Definitions, and integration wizards. Covers the Event API, webhook onboarding, and migration patterns from legacy ITOM tools.
