---
name: buildah-image-builder
description: |
  Construct OCI-compliant container images step-by-step with Buildah without requiring a container daemon.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [devops, containers, buildah]
---
