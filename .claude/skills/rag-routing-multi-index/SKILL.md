---
name: rag-routing-multi-index
description: |
  Advanced RAG pattern for rag-routing-multi-index covering production retrieval-augmented generation.
