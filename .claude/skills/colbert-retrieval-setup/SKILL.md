---
name: colbert-retrieval-setup
description: |
  Deploy ColBERT late-interaction retrievers with token-level similarity for high-recall semantic search.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [rag, colbert, retrieval]
---
# Colbert Retrieval Setup
