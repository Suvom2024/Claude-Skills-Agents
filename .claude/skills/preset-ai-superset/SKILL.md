---
name: preset-ai-superset
description: |
  Preset builds AI-native managed BI on Apache Superset with Preset Chatbot and MCP server for conversational dashboard creation and text-to-SQL. Focuses on enterprise governance and user-in-the-loop AI workflows for Superset users.
