---
name: arthur-ai-monitor
description: |
  Instrument models with Arthur Shield and Arthur Bench for production monitoring of performance, fairness, drift, and LLM quality. Registers models and streams inferences for observability.
