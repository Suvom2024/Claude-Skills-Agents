---
name: honeycomb-event-observability
description: |
  Instrument applications for Honeycomb's event-based observability with high-cardinality debugging.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [observability, honeycomb, tracing]
---
# Honeycomb Event Observability
