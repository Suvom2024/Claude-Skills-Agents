---
name: humanloop-platform
description: |
  Manage LLM prompts, run evaluations, and monitor AI features with Humanloop's enterprise platform for prompt versioning and A/B testing.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [observability, humanloop, prompts]
---
# Humanloop Platform
