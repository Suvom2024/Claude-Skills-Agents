---
name: myscale-sql-vector
description: |
  MyScale SQL-native vector database built on ClickHouse combining full SQL analytics with high-performance ANN indexes for hybrid structured+vector workloads. Good pick when teams want SQL-first vector search without separate engine.
