---
name: ai-code-migration-patterns
description: |
  Advanced patterns and configuration for ai-code-migration-patterns in AI-assisted development workflows.
