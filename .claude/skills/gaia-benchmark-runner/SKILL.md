...
description: |
  Tests Claude Code as a general AI assistant on GAIA's 466 real-world multi-step questions requiring web browsing, file handling, and tool use across three difficulty levels.
