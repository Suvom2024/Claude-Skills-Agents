...
description: |
  Evaluate and improve LLM application quality with Braintrust's enterprise evaluation platform featuring human-in-the-loop review and A/B testing.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [evaluation, braintrust, quality]
---
# Braintrust Eval
