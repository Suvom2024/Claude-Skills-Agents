...
description: |
  Route, observe, and manage LLM API calls through Portkey's AI gateway with load balancing, fallbacks, caching, and multi-provider abstraction.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [observability, gateway, portkey]
---
# Portkey Gateway
