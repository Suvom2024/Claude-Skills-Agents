---
name: garak-vuln-scan
description: |
  Use NVIDIA Garak LLM vulnerability scanner with probes for hallucination, leakage, injection, toxicity, and malware. Runs Garak in CI and fails builds on regressions.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, safety, scanner]
---
# Garak Vuln Scan
