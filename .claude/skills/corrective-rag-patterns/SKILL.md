---
name: corrective-rag-patterns
description: |
  Implement CRAG with retrieval evaluation, query rewriting, and web search fallback for self-correcting retrieval.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [rag, crag, retrieval]
---
