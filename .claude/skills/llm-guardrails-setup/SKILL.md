---
name: llm-guardrails-setup
description: |
  Configure guardrails using NeMo Guardrails or Guardrails AI for topic control and PII filtering.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [llm, guardrails, safety]
---
# Llm Guardrails Setup
