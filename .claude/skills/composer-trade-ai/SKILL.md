---
name: composer-trade-ai
description: |
  No-code automated trading platform with AI-driven symphony (strategy) generation from natural language. Create, backtest, and deploy multi-asset strategies programmatically, plus sync portfolio rebalancing schedules.
