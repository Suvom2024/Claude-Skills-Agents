...
name: pyrit-redteam
description: |
  Orchestrate Microsoft PyRIT attack scenarios (converters, orchestrators, scorers) against target LLMs. Build custom attack strategies, run them at scale, and score outputs.
