---
name: cc-custom-skill-authoring
description: |
  Create custom skills as .claude/skills/<name>/SKILL.md files with YAML frontmatter, auto-activation descriptions, and progressive reference files.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [claude-code, skills, authoring]
---
# Cc Custom Skill Authoring
