---
name: defold-game-patterns
description: |
  Defold engine Lua scripting, game object lifecycle, and render pipeline customization.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [gamedev, defold, lua]
---
# Defold Game Patterns
