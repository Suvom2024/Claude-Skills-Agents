---
name: airbyte-pyairbyte-ai
description: |
  Airbyte open-source ELT standard with 600+ connectors plus PyAirbyte for running connectors inside Python and ML workflows. Increasingly used in 2026 to feed vector databases, embedding pipelines, and RAG systems with structured and unstructured data.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [data, elt, pipelines]
---
# Airbyte Pyairbyte Ai
