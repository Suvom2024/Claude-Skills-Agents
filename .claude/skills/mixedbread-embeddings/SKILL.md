...
description: |
  mixedbread-ai (mxbai) offers compact, efficient open embedding models like mxbai-embed-large-v1 and mxbai-rerank, optimized for latency and cost-sensitive deployments. Good fit when self-hosting embeddings with small footprint.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, embeddings, opensource]
---
