---
name: figma-to-code-automation
description: |
  Automate Figma-to-code workflows using the Figma Dev Mode API, code generation plugins, and CI integration.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [design, figma, automation]
---
