---
name: trulens-feedback-loop
description: |
  Instrument LLM apps with TruLens for groundedness, relevance, and sentiment feedback functions.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [llm, evaluation, trulens]
---
# Trulens Feedback Loop
