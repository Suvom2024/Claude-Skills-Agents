---
name: cortex-service-catalog
description: |
  Set up Cortex for service catalog management with scorecards and engineering standards enforcement.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [platform, cortex, service-catalog]
---
