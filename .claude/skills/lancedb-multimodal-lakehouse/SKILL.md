---
name: lancedb-multimodal-lakehouse
description: |
  LanceDB open-source AI-native multimodal lakehouse built on Lance columnar format, offering disk-first IVF-PQ/HNSW indexes that scale to billions of vectors over S3. Top 2026 choice for multimodal RAG over video, images, and text.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, vector, multimodal]
---
