---
name: hex-notebook-agent
description: |
  Hex AI analytics platform combining notebooks, conversational self-serve, and data apps with Magic AI and Notebook Agent that writes SQL/Python, builds charts, and reasons over governed semantic models. Used by Ramp, Figma, and Anthropic.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, notebook, analytics]
---
# Hex Notebook Agent
