---
name: domain-prompt-financial
description: |
  Advanced prompt engineering patterns for domain-prompt-financial covering production LLM applications.
