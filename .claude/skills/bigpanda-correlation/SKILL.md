---
name: bigpanda-correlation
description: |
  Sets up BigPanda AIOps correlation patterns, enrichment maps, and integration pipelines. Handles OIM payload mapping, ServiceNow/Jira bidirectional sync, and topology-based correlation rules.
