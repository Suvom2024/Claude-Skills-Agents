---
name: deepeval-test-suite
description: |
  Build LLM evaluation suites with DeepEval metrics for faithfulness, relevancy, and hallucination detection.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [llm, evaluation, deepeval]
---
# Deepeval Test Suite
