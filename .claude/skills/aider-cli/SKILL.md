...
name: aider-cli
description: |
  Use Aider's terminal-based AI pair-programming workflow for multi-file editing with git-aware commits across Claude, Gemini, and GPT models.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, pair-programming, cli]
---
# Aider Cli
