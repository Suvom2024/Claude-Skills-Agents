---
name: react-server-components-deep
description: |
  Master advanced RSC patterns including streaming, server/client boundaries, data fetching, and serialization.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [react, rsc, advanced]
---
# React Server Components Deep
