---
name: fiddler-ai-observability
description: |
  Integrate Fiddler for explainability, drift detection, and LLM evaluation. Configures monitors, alerts, and root-cause analysis dashboards for production agents.
