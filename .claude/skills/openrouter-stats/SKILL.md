...
description: |
  Queries OpenRouter's live usage, latency, and throughput stats to route Claude Code fallback/overflow traffic to currently best-performing endpoint. Supports per-provider cost and uptime gating.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, routing, inference]
---
# Openrouter Stats
