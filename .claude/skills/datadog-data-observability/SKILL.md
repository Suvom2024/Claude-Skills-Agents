---
name: datadog-data-observability
description: |
  Datadog Data Observability (built on Metaplane) extends DevOps-grade monitoring to data pipelines with freshness, volume, schema, and quality checks unified with logs, traces, and metrics. Natural fit for Datadog-standardized orgs.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [data, observability, datadog]
---
