---
name: zitadel-auth-patterns
description: |
  Implement Zitadel for user management with OIDC, machine tokens, and multi-tenancy.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [auth, zitadel, identity]
---
# Zitadel Auth Patterns
