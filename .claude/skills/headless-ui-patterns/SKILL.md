...
description: |
  Implement accessible, renderless component patterns using Headless UI for dropdown, listbox, dialog, and menu primitives.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [components, headless-ui, accessibility]
---
