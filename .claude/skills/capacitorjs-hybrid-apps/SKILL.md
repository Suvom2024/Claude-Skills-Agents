---
name: capacitorjs-hybrid-apps
description: |
  Capacitor.js plugin authoring, native bridge patterns, and migration from Cordova.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [mobile, capacitor, hybrid]
---
# Capacitorjs Hybrid Apps
