---
name: kmp-shared-logic-patterns
description: |
  Kotlin Multiplatform shared business logic with expect/actual declarations and KMP-first architecture.
