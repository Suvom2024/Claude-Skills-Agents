...
name: galileo-evals
description: |
  Connects Claude Code to Galileo Evaluate + Observe products for Luna-2 guardrail model scoring, ChainPoll hallucination detection, and production monitoring. Supports fine-grained span-level metrics.
