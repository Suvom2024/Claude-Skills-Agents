---
name: cloudzero-unit-economics
description: |
  Sets up CloudZero CostFormation IaC and AnyCost connectors. Handles tag/allocation rule authoring, anomaly subscription config, and CUR/Focus export ingestion for unit cost KPIs.
