---
name: cc-model-switching
description: |
  Switch between Opus/Sonnet/Haiku models mid-session with /model, configure defaults, and use opusplan hybrid routing.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [claude-code, models, configuration]
---
# Cc Model Switching
