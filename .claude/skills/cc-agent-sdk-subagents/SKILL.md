---
name: cc-agent-sdk-subagents
description: |
  Create custom subagents with focused prompts and tool restrictions in .claude/agents/ with parallel dispatch and context isolation.
