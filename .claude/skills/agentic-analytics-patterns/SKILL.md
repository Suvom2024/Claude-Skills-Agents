---
name: agentic-analytics-patterns
description: |
  Architecture patterns for agentic BI: multi-step reasoning, hypothesis testing, self-validating SQL (like Genie Inspect), tool-use over warehouse catalogs, and human-in-the-loop approval. Captures how Databricks, Snowflake, Hex, and Wren build production analytics agents.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, analytics, agents]
---
# Agentic Analytics Patterns
