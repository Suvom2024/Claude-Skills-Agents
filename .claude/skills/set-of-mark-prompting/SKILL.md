---
name: set-of-mark-prompting
description: |
  Browser automation and computer-use patterns for set-of-mark-prompting to enable AI agents to interact with web/desktop interfaces in production.
