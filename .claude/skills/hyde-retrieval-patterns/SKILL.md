---
name: hyde-retrieval-patterns
description: |
  Advanced RAG pattern for hyde-retrieval-patterns covering production retrieval-augmented generation.
