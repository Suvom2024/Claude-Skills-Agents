---
name: kmp-compose-multiplatform-advanced
description: |
  Compose Multiplatform advanced patterns for iOS/Desktop/Web with platform-specific composables.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [mobile, kmp, compose]
---
# Kmp Compose Multiplatform Advanced
