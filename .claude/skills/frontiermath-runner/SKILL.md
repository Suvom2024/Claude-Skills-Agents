---
name: frontiermath-runner
description: |
  Tests Claude Code on Epoch AI's FrontierMath hundreds of research-level, unpublished math problems graded by expert mathematicians. Integrates sandbox execution for symbolic/numeric verification.
