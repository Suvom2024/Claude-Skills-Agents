---
name: webrtc-advanced-patterns
description: |
  WebRTC advanced patterns with SFU architectures, simulcast, bandwidth estimation, and data channels.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [protocol, webrtc, realtime]
---
# Webrtc Advanced Patterns
