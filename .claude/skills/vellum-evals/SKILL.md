...
name: vellum-evals
description: |
  Integrates Vellum evaluation workflows with Claude Code for test-case management, LLM-judge configuration, and multi-model bakeoffs. Ties into Vellum prompt deployment and monitoring.
