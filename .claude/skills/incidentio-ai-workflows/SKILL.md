---
name: incidentio-ai-workflows
description: |
  Integrates incident.io AI Suggestions and Investigations API to trigger follow-up tasks, summarize Slack threads, and push postmortem drafts. Includes catalog population, custom fields, and workflow YAML.
