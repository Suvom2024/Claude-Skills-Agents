---
name: css-layers-architecture
description: |
  Organize CSS specificity and cascade with @layer for scalable, conflict-free stylesheet architecture.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [css, layers, architecture]
---
