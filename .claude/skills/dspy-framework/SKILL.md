...
name: dspy-framework
description: |
  Optimize LLM pipelines with DSPy's program synthesis approach that replaces manual prompt engineering with automated compilation and eval-driven optimization.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, optimization, dspy]
---
# Dspy Framework
