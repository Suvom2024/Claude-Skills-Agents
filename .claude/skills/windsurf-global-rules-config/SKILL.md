---
name: windsurf-global-rules-config
description: |
  Advanced patterns and configuration for windsurf-global-rules-config in AI-assisted development workflows.
