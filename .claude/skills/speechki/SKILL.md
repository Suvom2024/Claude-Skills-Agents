...
name: speechki
description: |
  Text-to-speech service with 1,100+ voices across 80+ languages and audiobook-focused features. Integration supports large-scale narration projects with SSML control and commercial licensing.
