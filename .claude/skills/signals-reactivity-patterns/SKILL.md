---
name: signals-reactivity-patterns
description: |
  Implement the signals paradigm for fine-grained reactivity across Solid, Angular, Preact, and the TC39 proposal.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [frontend, signals, reactivity]
---
