---
name: park-ui-components
description: |
  Scaffold styled component systems using Park UI's pre-designed components built on Ark UI and Panda CSS.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [components, park-ui, styled]
---
# Park Ui Components
