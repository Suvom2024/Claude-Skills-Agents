...
description: |
  BGE-M3 BAAI's multi-functional, multi-lingual, multi-granularity embedding supporting dense, sparse, and multi-vector retrieval in one model (MTEB ~63.0). Widely used open-weight default for hybrid retrieval pipelines.
