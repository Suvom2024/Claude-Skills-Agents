---
name: alpinejs-patterns
description: |
  Create lightweight reactive components using Alpine.js directives for progressive enhancement without a build step.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [frontend, alpinejs, lightweight]
---
# Alpinejs Patterns
