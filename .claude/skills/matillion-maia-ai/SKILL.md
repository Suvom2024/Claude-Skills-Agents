---
name: matillion-maia-ai
description: |
  Matillion cloud-first ETL/ELT platform for Snowflake, BigQuery, Databricks, and Redshift with AI features like Maia copilot that authors pipelines from natural language. Low-code productivity for data engineering teams.
