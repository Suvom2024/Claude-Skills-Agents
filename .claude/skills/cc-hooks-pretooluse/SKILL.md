---
name: cc-hooks-pretooluse
description: |
  Configure PreToolUse hooks that intercept tool calls before execution, enabling security gates, file protection rules, and mandatory review enforcement in Claude Code.
