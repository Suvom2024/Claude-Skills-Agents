---
name: mcp-server-builder-python
description: |
  Comprehensive patterns for building and configuring the mcp-server-builder-python MCP server for AI agent integration and Claude Code workflows.
