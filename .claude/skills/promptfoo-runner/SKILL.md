...
description: |
  Integrates promptfoo's YAML-driven eval pipelines to diff Claude Code prompts across variants, providers, and test assertions (contains, llm-rubric, factuality). Ideal for PR-gated prompt regression in CI.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, evals, prompts]
---
# Promptfoo Runner
