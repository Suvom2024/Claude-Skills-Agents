---
name: css-scope-starting-style
description: |
  Use @scope for component-scoped styles and @starting-style for clean enter/exit transitions without JavaScript.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [css, scope, transitions]
---
# Css Scope Starting Style
