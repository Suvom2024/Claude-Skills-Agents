...
name: fingpt
description: |
  Open-source financial LLM framework for sentiment analysis, forecasting, and RAG over financial corpora. Install FinGPT locally or via HuggingFace, fine-tune on custom datasets, and run inference on earnings/news.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, finance, llm, opensource]
---
# Fingpt
