...
description: |
  Commission-free stock and crypto brokerage with REST/WebSocket APIs for algorithmic trading. Enables order placement, paper trading, market data streaming, and portfolio management from Claude Code workflows.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [trading, brokerage, api]
---
# Alpaca Markets Api
