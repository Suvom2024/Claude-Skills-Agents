---
name: vercel-edge-runtime-patterns
description: |
  Build Vercel Edge Functions and Middleware with streaming and geolocation-based routing.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [edge, vercel, serverless]
---
# Vercel Edge Runtime Patterns
