---
name: memphis-dev-streaming
description: |
  Build event-driven applications with Memphis.dev's schemaless producers and dead-letter queues.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [streaming, memphis, events]
---
# Memphis Dev Streaming
