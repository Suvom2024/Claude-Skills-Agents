...
description: |
  Build TypeScript AI agents and applications with Mastra's framework featuring workflow orchestration, RAG, evals, and observability.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, typescript, mastra]
---
# Mastra Framework
