---
name: llm-multimodal-input-patterns
description: |
  LLM API integration pattern for llm-multimodal-input-patterns covering production AI applications.
