...
description: |
  Apply Google Cloud Model Armor templates for prompt injection, jailbreak, data loss, and malicious URL screening. Sets up templates in GCP and wires sanitization into Vertex AI agent requests.
