---
name: cc-worktree-parallel-dev
description: |
  Run parallel Claude sessions across git worktrees with /batch orchestration for large-scale simultaneous changes.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [claude-code, worktree, parallel]
---
# Cc Worktree Parallel Dev
