---
name: apache-pulsar-patterns
description: |
  Design multi-tenant messaging with Apache Pulsar including tiered storage and geo-replication.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [streaming, pulsar, messaging]
---
