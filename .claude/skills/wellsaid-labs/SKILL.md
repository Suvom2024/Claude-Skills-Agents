...
name: wellsaid-labs
description: |
  Enterprise synthetic voice platform with high-quality AI voice avatars built from professional voice actors. API integration provides consistent, licensed voiceovers for training videos, ads, and IVR.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, tts, enterprise]
---
# Wellsaid Labs
