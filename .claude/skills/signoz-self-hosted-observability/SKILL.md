---
name: signoz-self-hosted-observability
description: |
  Deploy SigNoz as an open-source OpenTelemetry-native alternative for unified metrics, traces, and logs.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [observability, signoz, open-source]
---
