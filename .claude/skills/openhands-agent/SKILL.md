...
description: |
  Deploy and customize OpenHands (formerly OpenDevin), the leading open-source AI coding agent supporting any LLM backend with SWE-bench-verified performance.
