---
name: mcp-ide-integration
description: |
  Comprehensive patterns for building and configuring the mcp-ide-integration MCP server for AI agent integration and Claude Code workflows.
