---
name: lakera-guard-integration
description: |
  Wraps Claude Code tool calls with Lakera Guard prompt-injection, PII, and content-moderation detectors as real-time runtime shield. Also supports pre-deploy Lakera Red red-teaming runs.
