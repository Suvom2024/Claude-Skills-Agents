---
name: mcp-resource-prompt-patterns
description: |
  Comprehensive patterns for building and configuring the mcp-resource-prompt-patterns MCP server for AI agent integration and Claude Code workflows.
