---
name: langkit-telemetry
description: |
  Instrument LLMs with WhyLabs LangKit for prompt/response telemetry: toxicity, sentiment, refusals, relevance, and jailbreak similarity. Exports metrics to WhyLabs or OpenTelemetry for drift and safety dashboards.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, observability, safety]
---
# Langkit Telemetry
