...
name: tickeron-ai
description: |
  AI pattern-recognition platform for stocks, ETFs, forex, and crypto with AI Robots that trade autonomously. Wraps the Tickeron API for AI signals, pattern scans, and robot performance metrics.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, trading, patterns]
---
# Tickeron Ai
