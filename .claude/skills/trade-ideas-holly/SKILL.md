...
description: |
  AI-powered stock scanning tool using the Holly virtual analyst to surface real-time trade opportunities. Query Holly's AI picks, run custom scans via API, and pipe signals into automated workflows.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, trading, stocks]
---
# Trade Ideas Holly
