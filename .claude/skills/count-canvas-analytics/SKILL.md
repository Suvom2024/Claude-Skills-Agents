---
name: count-canvas-analytics
description: |
  Count is a collaborative canvas-style BI tool combining SQL, Python, and visualization on an infinite canvas with AI-assisted exploration and commentary. Popular with data teams doing exploratory analysis and storytelling.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, bi, analytics]
---
# Count Canvas Analytics
