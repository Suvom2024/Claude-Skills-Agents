...
description: |
  De-anonymization platform with AI entity clustering across blockchains. Enables querying Arkham's entity graph, tracking whale flows, and building intel dashboards.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, crypto, intelligence]
---
# Arkham Intelligence
