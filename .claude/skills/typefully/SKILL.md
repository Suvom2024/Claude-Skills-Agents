...
name: typefully
description: |
  Twitter/X and Threads-focused composer with AI drafting, thread building, and analytics. Integration supports thread expansion from outlines, rewriting for engagement, and scheduling.
