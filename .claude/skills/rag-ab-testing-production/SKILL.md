---
name: rag-ab-testing-production
description: |
  Advanced RAG pattern for rag-ab-testing-production covering production retrieval-augmented generation.
