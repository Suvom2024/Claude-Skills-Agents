---
name: gitpod-workspace-patterns
description: |
  Gitpod workspace configuration, .gitpod.yml recipes, prebuild optimization, and custom Docker images.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [devops, gitpod, workspace]
---
