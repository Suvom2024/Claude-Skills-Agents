---
name: threejs-game-patterns
description: |
  Three.js interactive 3D and game patterns with custom shaders and physics integration.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [gamedev, threejs, 3d]
---
# Threejs Game Patterns
