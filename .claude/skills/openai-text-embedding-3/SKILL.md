...
description: |
  OpenAI text-embedding-3-small and text-embedding-3-large remain widely used general-purpose embeddings with dimension trimming (Matryoshka) and strong MTEB performance (~64.6 on large). Default integration path for OpenAI-stack teams.
