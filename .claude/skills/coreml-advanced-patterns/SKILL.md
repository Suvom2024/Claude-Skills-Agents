---
name: coreml-advanced-patterns
description: |
  Core ML advanced patterns with model conversion, custom layers, and on-device training.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [edge-ai, coreml, ios]
---
# Coreml Advanced Patterns
