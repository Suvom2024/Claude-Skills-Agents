---
name: vantage-cost-reporting
description: |
  Integrates Vantage cost reports, budgets, and Kubernetes efficiency data. Covers the Vantage API, custom cost folders, and VQL query authoring for cross-cloud allocation.
