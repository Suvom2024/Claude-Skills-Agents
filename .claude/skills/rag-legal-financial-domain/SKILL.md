---
name: rag-legal-financial-domain
description: |
  Advanced RAG pattern for rag-legal-financial-domain covering production retrieval-augmented generation.
