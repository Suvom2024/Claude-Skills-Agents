---
name: aceternity-ui-animations
description: |
  Create rich animated interfaces using Aceternity UI's Framer Motion-powered copy-paste component library.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [components, aceternity, animations]
---
