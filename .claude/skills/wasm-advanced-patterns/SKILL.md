---
name: wasm-advanced-patterns
description: |
  WebAssembly advanced patterns with component model, SIMD, threads, and language interop.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [wasm, webassembly, advanced]
---
# Wasm Advanced Patterns
