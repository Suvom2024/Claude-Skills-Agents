---
name: mcp-server-database-multi
description: |
  Comprehensive patterns for building and configuring the mcp-server-database-multi MCP server for AI agent integration and Claude Code workflows.
