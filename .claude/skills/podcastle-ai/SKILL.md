...
name: podcastle-ai
description: |
  Browser-based podcast creation suite with Magic Dust audio enhancement and AI voice cloning. Integration covers recording, multi-track editing, and automated show notes generation.
