...
name: codex-cli
description: |
  Use OpenAI's open-source Codex CLI local coding agent powered by codex-1 for parallel task execution with sandboxed filesystem and network access.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, coding-agent, openai]
---
# Codex Cli
