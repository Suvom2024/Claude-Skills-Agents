---
name: promptarmor-defense
description: |
  Apply PromptArmor injection detection to agent workflows. Validates tool-call inputs and retrieved context for hidden instructions, indirect injection patterns, and exfiltration attempts across RAG pipelines.
