...
description: |
  Configure NVIDIA NeMo Guardrails with Colang flows for topical, safety, and dialog rails. Scaffolds config.yml, defines rail actions, and integrates with LangChain agents for programmable constraints.
