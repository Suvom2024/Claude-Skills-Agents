---
name: claude-as-judge
description: |
  Configures Claude (Opus/Sonnet) as grading model for Claude Code evals using Anthropic's documented judge prompts, explicit rubrics, and confidence extraction. Handles 'don't grade yourself' separation with distinct judge model IDs.
