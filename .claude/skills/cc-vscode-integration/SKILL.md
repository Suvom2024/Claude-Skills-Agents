---
name: cc-vscode-integration
description: |
  Use Claude Code VS Code extension with auto-context sharing, diff viewer, multi-tab conversations, and plan/auto-accept modes.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [claude-code, vscode, ide]
---
# Cc Vscode Integration
