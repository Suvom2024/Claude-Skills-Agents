---
name: browserless-browserql
description: |
  Browser automation and computer-use patterns for browserless-browserql to enable AI agents to interact with web/desktop interfaces in production.
