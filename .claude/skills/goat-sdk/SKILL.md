...
name: goat-sdk
description: |
  Great Onchain Agent Toolkit - modular SDK for giving LLM agents onchain capabilities across 30+ chains. Installs GOAT plugins (Uniswap, Jupiter, Polymarket) and wires them to LangChain/Vercel AI SDK workflows.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, crypto, agents, sdk]
---
# Goat Sdk
