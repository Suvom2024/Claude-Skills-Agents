---
name: ragas-evaluation-setup
description: |
  Evaluate RAG pipelines with RAGAS metrics for context precision, recall, faithfulness, and correctness.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [llm, evaluation, ragas]
---
