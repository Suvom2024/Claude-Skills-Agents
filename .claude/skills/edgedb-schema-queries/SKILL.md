---
name: edgedb-schema-queries
description: |
  Model data with EdgeDB's schema DSL and write EdgeQL queries with TypeScript query builder.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [database, edgedb, schema]
---
# Edgedb Schema Queries
