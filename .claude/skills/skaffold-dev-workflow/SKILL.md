---
name: skaffold-dev-workflow
description: |
  Set up Skaffold for continuous Kubernetes development with automatic build, push, deploy on code changes.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [devops, kubernetes, skaffold]
---
