...
name: bolt-new
description: |
  Scaffold and deploy full-stack apps in-browser using StackBlitz's Bolt.new WebContainer-powered AI builder with zero local setup.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, app-builder, stackblitz]
---
# Bolt New
