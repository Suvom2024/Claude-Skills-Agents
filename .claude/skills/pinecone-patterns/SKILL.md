---
name: pinecone-patterns
description: |
  Design Pinecone namespaces, metadata filtering, hybrid search, and serverless index lifecycle management.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [vector-db, pinecone, search]
---
# Pinecone Patterns
