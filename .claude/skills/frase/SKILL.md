...
name: frase
description: |
  AI content research and optimization tool focused on answer engine optimization (AEO) and SERP briefs. API enables automated brief generation from target keywords, followed by full-article drafting aligned to competitive outlines.
