---
name: rspack-build-tooling
description: |
  Accelerate builds with Rspack, the Rust-based Webpack-compatible bundler, for large-scale frontend projects.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [build, rspack, rust]
---
# Rspack Build Tooling
