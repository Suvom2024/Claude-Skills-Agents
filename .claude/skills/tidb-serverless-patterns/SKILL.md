---
name: tidb-serverless-patterns
description: |
  Build on TiDB Serverless with HTAP workloads and MySQL-compatible distributed SQL.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [database, tidb, serverless]
---
# Tidb Serverless Patterns
