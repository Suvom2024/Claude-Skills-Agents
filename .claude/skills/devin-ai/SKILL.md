...
name: devin-ai
description: |
  Build with Cognition's Devin autonomous coding agent, including SWE-1.5 models, Windsurf IDE integration, and agent-mode API for delegating multi-file engineering tasks.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, coding-agent, devin]
---
# Devin Ai
