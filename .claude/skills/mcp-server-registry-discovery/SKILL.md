---
name: mcp-server-registry-discovery
description: |
  Comprehensive patterns for building and configuring the mcp-server-registry-discovery MCP server for AI agent integration and Claude Code workflows.
