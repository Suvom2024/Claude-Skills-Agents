---
name: otel-collector-patterns
description: |
  Design OpenTelemetry Collector deployment patterns with processors, exporters, and tail sampling.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [observability, opentelemetry, collector]
---
