---
name: fivetran-ai-connectors
description: |
  Fivetran fully managed CDC and ELT pipelines with automated schema evolution and enterprise compliance, plus AI-assisted connector configuration and hybrid deployment. Remains the default for compliance-heavy enterprise data ingestion.
