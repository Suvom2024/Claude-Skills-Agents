...
name: arize-phoenix
description: |
  Monitor AI agent performance with Arize Phoenix's open-source observability featuring OpenTelemetry tracing and hallucination detection.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [observability, arize, open-source]
---
# Arize Phoenix
