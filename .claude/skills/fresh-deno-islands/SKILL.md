---
name: fresh-deno-islands
description: |
  Create zero-config, island-based web apps using Fresh 2.x on Deno with edge rendering and no build step.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [frontend, deno, islands]
---
# Fresh Deno Islands
