---
name: graphile-worker-patterns
description: |
  Implement PostgreSQL-native job queues with Graphile Worker and crontab.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [jobs, graphile, postgres]
---
# Graphile Worker Patterns
