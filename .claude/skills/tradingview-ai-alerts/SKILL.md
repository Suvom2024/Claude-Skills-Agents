...
description: |
  Charting platform with AI-enhanced alert conditions, Pine Script generation, and pattern recognition. Generate Pine Script indicators/strategies, manage webhook alerts, and fetch technical analysis data.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, trading, charts]
---
