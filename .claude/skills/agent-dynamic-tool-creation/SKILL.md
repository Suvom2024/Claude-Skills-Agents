---
name: agent-dynamic-tool-creation
description: |
  Agent architecture pattern for agent-dynamic-tool-creation covering autonomous AI agent design.
