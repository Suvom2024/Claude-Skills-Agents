...
name: continue-dev
description: |
  Set up Continue.dev open-source IDE extension to create custom AI coding assistants with autocomplete, chat, and context-aware editing.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, ide-extension, open-source]
---
# Continue Dev
