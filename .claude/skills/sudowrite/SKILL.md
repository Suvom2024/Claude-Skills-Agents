...
name: sudowrite
description: |
  Fiction-focused AI writing tool with features like Story Engine, Canvas, and Brainstorm for novelists. Integration supports chapter drafting, character development, and scene expansion with genre-aware style control.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, writing, fiction]
---
# Sudowrite
