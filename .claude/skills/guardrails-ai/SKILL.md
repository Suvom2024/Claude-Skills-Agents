...
name: guardrails-ai
description: |
  Build Guardrails AI validators and RAIL specs for structured LLM output enforcement. Generate validator pipelines covering toxicity, PII, competitor mentions, and custom schema guarantees with automatic reasking.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, safety, validators]
---
# Guardrails Ai
