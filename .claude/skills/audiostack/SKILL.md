...
name: audiostack
description: |
  Programmatic audio production platform for generating ads, podcasts, and narrations at scale. API orchestrates voice, music, and mixing for template-based audio content across languages.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, audio, production]
---
# Audiostack
