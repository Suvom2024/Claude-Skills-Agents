...
description: |
  Leverage Amazon Q Developer's AI coding assistant for AWS-native development including /dev agents, infrastructure-as-code generation, and CloudWatch integration.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [ai, aws, coding-assistant]
---
# Amazon Q Developer
