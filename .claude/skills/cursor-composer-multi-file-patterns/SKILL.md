---
name: cursor-composer-multi-file-patterns
description: |
  Advanced patterns and configuration for cursor-composer-multi-file-patterns in AI-assisted development workflows.
...
---
# Cursor Composer Multi File Patterns
