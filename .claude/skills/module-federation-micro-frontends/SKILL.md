---
name: module-federation-micro-frontends
description: |
  Compose independently deployed micro-frontends using Module Federation for runtime code sharing.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [frontend, micro-frontends, module-federation]
---
