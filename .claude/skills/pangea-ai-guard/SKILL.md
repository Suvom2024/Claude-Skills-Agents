...
description: |
  Adds Pangea AI Guard's prompt-injection, malicious-entity, and data-leakage filters to Claude Code's input/output path. Provides audit logs and configurable block/redact policies.
