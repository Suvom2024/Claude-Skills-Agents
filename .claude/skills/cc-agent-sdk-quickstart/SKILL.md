---
name: cc-agent-sdk-quickstart
description: |
  Get started with the Claude Agent SDK for Python/TypeScript: query() function, built-in tools, headless execution, and custom agent building.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [claude-code, agent-sdk, development]
---
# Cc Agent Sdk Quickstart
