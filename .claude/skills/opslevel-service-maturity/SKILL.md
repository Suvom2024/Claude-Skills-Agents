---
name: opslevel-service-maturity
description: |
  Configure OpsLevel service catalog with maturity rubrics and campaign-driven reliability improvements.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [platform, opslevel, service-maturity]
---
