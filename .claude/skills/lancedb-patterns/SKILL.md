---
name: lancedb-patterns
description: |
  Use LanceDB for serverless vector storage on object stores with Lance columnar format and full-text search.
allowed-tools: Read, Write, Bash(cmd:*)
version: 1.0.0
author: Claude Skills Agents <suvom2024@github.com>
license: MIT
compatible-with: claude-code, codex, openclaw
tags: [vector-db, lancedb, serverless]
---
# Lancedb Patterns
