...
skills: storybook-testing, builder-factory, accessibility-audit, tailwind-css-4, react-19-compiler, playwright-cli, toast-notifications, server-actions, design-system-component, szum-tech-design-system
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
